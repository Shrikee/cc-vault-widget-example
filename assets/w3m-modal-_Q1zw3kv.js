import{c as u,n as w,d as O,r as d,i as N,b as n,o as Q,U as be,a as ye}from"./index-CdkWfYvk.js";import{p as xe,s as Ce,q as ke,t as Se,M as v,u as de,R as l,i as _,r as B,a as D,b as f,v as X,e as we,o as ue,k as m,g as F,l as We,x as k,E as ne,O as I,C as Z,y as se,m as T,c as V,T as $e,z as Re,d as Te,j as Ae}from"./core-fSHA0rPV.js";import"./index-D6OIT761.js";import"./index.es-B-ua_Xua.js";const p=Se({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),Oe={state:p,subscribe(s){return ke(p,()=>s(p))},subscribeKey(s,e){return Ce(p,s,e)},showTooltip({message:s,triggerRect:e,variant:t}){p.open=!0,p.message=s,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},A=xe(Oe),pe={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){v.shake();return}if(await de.isSIWXCloseDisabled()){v.shake();return}v.close()}},Ne=_`
  :host {
    display: block;
